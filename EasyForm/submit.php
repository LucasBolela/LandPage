...
error_reporting(0);
$emailAddress = 'suporte@softup.com.br';
...
<tr>
<td style="width:35%;background:#263238;color:#eceff1;padding: 10px;text-transform: uppercase;">Field</td>
<td style="width:65%;background:#263238;color:#eceff1;padding: 10px;text-transform: uppercase;">Entry</td>
</tr>
<tr>
...
<td style="padding: 10px 8px;">'.$_POST['company'].'</td>
</tr>
<tr>
<td style="padding: 10px 8px;background: #f5f5f5;">Phone:</td>
<td style="padding: 10px 8px;background: #f5f5f5;">'.$_POST['phone'].'</td>
</tr>
<tr>
<td style="padding: 10px 8px;">Message:</td>
<td style="padding: 10px 8px;">'.$_POST['message'].'</td>
</tr>
</table>
<br>
